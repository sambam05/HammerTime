    ...
    public static GeneralConfig load() {
        ...
        try (CommentedFileConfig fileConfig = CommentedFileConfig.builder(CONFIG_FILE)
            ...
            if (CONFIG_FILE.exists()) {
                ...
                fileConfig.setComment("VillagerTrades.tradeChance", "Chance the librarian offers the hammer enchantment trade (0.0–1.0).  1.0 is not 100%, it just increase the chance.");

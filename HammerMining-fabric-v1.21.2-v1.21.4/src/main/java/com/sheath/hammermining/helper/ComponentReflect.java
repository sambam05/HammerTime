...
public class ComponentReflect {
    ...
    static {
        ...
        try {
            ...
            // Builder constructor signature may differ or be unavailable; we'll fall back to direct ctor.
        }

        // Try known ctor signatures (2-arg then 1-arg) to stay compatible across minor versions
    ...
    public static ItemEnchantmentsComponent make(Map<? extends RegistryEntry<Enchantment>, Integer> map) {
        ...
        // Preferred: use the Builder to populate and build the component
        if (builderCtor != null) {
            try {
                ...
                // fall through to direct ctor
            }
        }

        // Fallback: use the direct constructor we could access
        try {
